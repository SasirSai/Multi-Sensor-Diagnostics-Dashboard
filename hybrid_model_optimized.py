"""
hybrid_model_optimized.py
========================
OPTIMIZED HYBRID ARCHITECTURE: Random Forest + Isolation Forest (Feature Injection)
...
4. Strictly isolated model outputs to models/hybrid_optimized/.
"""
...
def main():
    ...
    model_dir = os.path.join(BASE_DIR, "models", "hybrid_optimized")
    ...
    # STEP 5 — Save strictly to models/hybrid_optimized/ (completely safe)
    analytics = {
        "architecture": "Random Forest + Isolation Forest (Feature Injection) [Optimized]",
